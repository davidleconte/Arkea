...
Conforme EXACTEMENT à : https://docs.datastax.com/en/hyper-converged-database/1.2/api-reference/dataapiclient.html
...
print("=" * 80)
print("📚 Documentation : https://docs.datastax.com/en/hyper-converged-database/1.2/api-reference/dataapiclient.html")
print()
    ...
    try:
        ...
        if result:
            ...
            for key, value in result.items():
                if key not in ['operation_data', 'cobol_data_base64']:  # Éviter d'afficher les BLOB
                    print(f"   {key}: {value}")
            print()
            GET_OK = True
        else:
