...
- `05_load_operations_data_parquet.sh` - Chargement batch opérations
- `07_load_category_data_realtime.sh` - Chargement temps réel catégories
...
**Documents Associés** :
- `02_LISTE_DETAIL_DEMONSTRATIONS.md` - Liste détaillée des démonstrations
- `18_INDEX_USE_CASES_SCRIPTS.md` - Index use cases → scripts
