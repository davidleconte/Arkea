...
def main():
    ...
    for query, description in test_cases:
        ...
        if relevance['is_mostly_relevant']:
            print(f"   ✅ Pertinence OK : {relevance['relevant_count']}/{relevance['total_count']} résultats pertinents")
        else:
            print(f"   ⚠️  Pertinence faible : {relevance['relevant_count']}/{relevance['total_count']} résultats pertinents")
