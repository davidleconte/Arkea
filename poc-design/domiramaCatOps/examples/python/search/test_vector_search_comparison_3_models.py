...
from test_vector_search_base_e5 import encode_text_e5, load_model_e5, vector_search_e5
from test_vector_search_base_invoice import (
    encode_text_invoice,
    load_model_invoice,
    vector_search_invoice,
)
    ...
    for query in test_queries:
        ...
        if INVOICE_AVAILABLE:
            ...
            results_invoice = vector_search_invoice(
                session, embedding_invoice, code_si, contrat, limit=5
            )
            ...
            print(
                f"      Pertinence : {relevance_invoice['relevant_count']}/{relevance_invoice['total_count']} ({relevance_invoice['relevance_rate']:.1%})"
            )
