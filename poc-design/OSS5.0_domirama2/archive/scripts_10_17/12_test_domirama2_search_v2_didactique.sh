...
TEST_OUTPUT=$(timeout 30 ./bin/cqlsh localhost 9042 -f "$TEST_FILE" 2>&1) || TEST_EXIT_CODE=$?
...
RESULT1=$(./bin/cqlsh localhost 9042 -e "USE domirama2_poc; SELECT COUNT(*) FROM operations_by_account WHERE code_si = '01' AND contrat = '1234567890' AND libelle : 'loyer' LIMIT 10;" 2>&1 | grep -v "Warnings" | grep -E "^[[:space:]]*[0-9]+" | head -1 | tr -d ' ')
...
RESULT4=$(./bin/cqlsh localhost 9042 -e "USE domirama2_poc; SELECT COUNT(*) FROM operations_by_account WHERE code_si = '01' AND contrat = '1234567890' AND cat_auto = 'HABITATION' LIMIT 10;" 2>&1 | grep -v "Warnings" | grep -E "^[[:space:]]*[0-9]+" | head -1 | tr -d ' ')
if [ -n "$RESULT4" ]; then
...
RESULT10=$(./bin/cqlsh localhost 9042 -e "USE domirama2_poc; SELECT COUNT(*) FROM operations_by_account WHERE code_si = '01' AND contrat = '1234567890' AND libelle : 'Loyer' LIMIT 10;" 2>&1 | grep -v "Warnings" | grep -E "^[[:space:]]*[0-9]+" | head -1 | tr -d ' ')
...
RESULT11=$(./bin/cqlsh localhost 9042 -e "USE domirama2_poc; SELECT COUNT(*) FROM operations_by_account WHERE code_si = '01' AND contrat = '1234567890' AND libelle : 'loyers' LIMIT 10;" 2>&1 | grep -v "Warnings" | grep -E "^[[:space:]]*[0-9]+" | head -1 | tr -d ' ')
