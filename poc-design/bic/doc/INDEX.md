# 📑 Index de la Documentation - POC BIC
...
- `04_IMPLEMENTATION_API.md` - Implémentation de l'API
...
- `04_RESULTS_DEMONSTRATION.md` - Résultats des démonstrations
...
**Fichiers prévus** : (à créer selon les besoins)
...
**Fichiers prévus** : (générés automatiquement par les scripts)
...
- **Design** : [`design/01_DATA_MODEL.md`](design/01_DATA_MODEL.md)
- **Setup** : [`guides/02_GUIDE_SETUP.md`](guides/02_GUIDE_SETUP.md)
