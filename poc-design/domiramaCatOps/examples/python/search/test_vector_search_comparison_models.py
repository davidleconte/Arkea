    ...
    for query in test_queries:
        ...
        if E5_AVAILABLE:
            ...
            if relevance_e5['relevance_rate'] > relevance_byt5['relevance_rate']:
                print(f"      ✅ e5-large plus pertinent (+{((relevance_e5['relevance_rate'] - relevance_byt5['relevance_rate']) * 100):.1f}%)")
            elif relevance_byt5['relevance_rate'] > relevance_e5['relevance_rate']:
                print(f"      ⚠️  ByteT5 plus pertinent (+{((relevance_byt5['relevance_rate'] - relevance_e5['relevance_rate']) * 100):.1f}%)")
            else:
