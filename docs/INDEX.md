# 📚 Arkea PoC — Index Canonique de Documentation

**Dernière mise à jour** : 2026-03-12
**Objectif** : fournir une navigation claire vers les documents de référence actifs.
...
- [ORGANISATION_FINALE.md](ORGANISATION_FINALE.md) — structure cible du projet
- [REFERENCE_HCD_DOCUMENTATION.md](REFERENCE_HCD_DOCUMENTATION.md) — référence technique HCD

## 2) Setup / Run / Ops

- [CONFIGURATION_ENVIRONNEMENT.md](CONFIGURATION_ENVIRONNEMENT.md) — configuration environnement
- [DEPLOYMENT.md](DEPLOYMENT.md) — déploiement
- [TROUBLESHOOTING.md](TROUBLESHOOTING.md) — dépannage

## 3) Tests / Validation

- [IMPLEMENTATION_PRIORITES_1_2_3.md](IMPLEMENTATION_PRIORITES_1_2_3.md) — état d’implémentation
- [RESULTATS_TEST_KAFKA_HCD.md](RESULTATS_TEST_KAFKA_HCD.md) — résultats de tests Kafka → HCD
...
## Références hors `docs/` (à conserver)

- Inputs client : `inputs-clients/`
- Inputs IBM : `inputs-ibm/`
- Évidence PoC : `poc-design/*/doc/`
