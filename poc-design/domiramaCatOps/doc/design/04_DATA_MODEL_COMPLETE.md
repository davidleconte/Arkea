...
CREATE TABLE domiramacatops_poc.operations_by_account (
    ...
    libelle_embedding_e5 VECTOR<FLOAT, 1024>,  -- Embeddings e5-large (intfloat/multilingual-e5-large)
    libelle_embedding_invoice VECTOR<FLOAT, 768>,  -- Embeddings facturation (NoureddineSa/Invoices_bilingual-embedding-large)
...
- **Vector Search ByteT5** : `idx_libelle_embedding_vector` sur `libelle_embedding` (fuzzy search avec ByteT5)
- **Vector Search e5-large** : `idx_libelle_embedding_e5_vector` sur `libelle_embedding_e5` (recherche sémantique multilingue)
- **Vector Search Invoice** : `idx_libelle_embedding_invoice_vector` sur `libelle_embedding_invoice` (recherche spécialisée facturation)
...
- `idx_libelle_embedding_e5_vector` : ANN sur `libelle_embedding_e5` (e5-large)
- `idx_libelle_embedding_invoice_vector` : ANN sur `libelle_embedding_invoice` (invoice)
...
16. `17_add_e5_embedding_column.sh` : Ajout colonne embedding e5-large
17. `18_add_invoice_embedding_column.sh` : Ajout colonne embedding facturation
18. `18_generate_embeddings_e5_auto.sh` : Génération embeddings e5-large
19. `19_generate_embeddings_invoice.sh` : Génération embeddings facturation
20. `19_test_embeddings_comparison.sh` : Comparaison modèles embeddings
