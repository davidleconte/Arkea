...
from test_vector_search_base import (
    ...
    connect_to_hcd, get_test_account, calculate_cosine_similarity, KEYSPACE
)

def vector_search_with_threshold(session, query_embedding, code_si: str, contrat: str, threshold: float = 0.7, limit: int = 5):
...
def main():
    ...
    for query in test_queries:
        ...
        for threshold in thresholds:
            ...
            results = vector_search_with_threshold(session, query_embedding, code_si, contrat, threshold=threshold, limit=5)
