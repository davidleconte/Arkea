...
if ! pgrep -f "cassandra" > /dev/null; then
    ...
    cd "$INSTALL_DIR" && ./03_start_hcd.sh || {
...
if [ -f "11_load_domirama2_data_parquet.sh" ]; then
    ...
    jenv local 11
    eval "$(jenv init -)"
    COUNT=$(./bin/cqlsh localhost 9042 -e "USE domirama2_poc; SELECT COUNT(*) FROM operations_by_account;" 2>&1 | grep -v "Warnings" | grep -E "^[[:space:]]*[0-9]+" | head -1 | tr -d ' ' || echo "0")
...
echo ""
demo "📊 Résultats :"
./bin/cqlsh localhost 9042 -e "USE domirama2_poc; SELECT libelle, montant, cat_auto FROM operations_by_account WHERE code_si = '$CODE_SI' AND contrat = '$CONTRAT' AND libelle : 'loyer' LIMIT 5;" 2>&1 | grep -v "Warnings" | head -10
echo ""
...
echo ""
demo "📊 Résultats :"
./bin/cqlsh localhost 9042 -e "USE domirama2_poc; SELECT libelle, montant FROM operations_by_account WHERE code_si = '$CODE_SI' AND contrat = '$CONTRAT' AND libelle : 'loyers' LIMIT 5;" 2>&1 | grep -v "Warnings" | head -10
echo ""
...
echo ""
demo "📊 Résultats :"
./bin/cqlsh localhost 9042 -e "USE domirama2_poc; SELECT libelle, montant FROM operations_by_account WHERE code_si = '$CODE_SI' AND contrat = '$CONTRAT' AND libelle : 'impayé' LIMIT 5;" 2>&1 | grep -v "Warnings" | head -10
echo ""
...
echo ""
demo "📊 Résultats :"
./bin/cqlsh localhost 9042 -e "USE domirama2_poc; SELECT libelle, montant, cat_auto FROM operations_by_account WHERE code_si = '$CODE_SI' AND contrat = '$CONTRAT' AND libelle : 'loyer' AND libelle : 'paris' LIMIT 5;" 2>&1 | grep -v "Warnings" | head -10
echo ""
...
echo ""
demo "📊 Résultats :"
./bin/cqlsh localhost 9042 -e "USE domirama2_poc; SELECT libelle, montant, type_operation FROM operations_by_account WHERE code_si = '$CODE_SI' AND contrat = '$CONTRAT' AND libelle : 'virement' AND libelle : 'impaye' LIMIT 5;" 2>&1 | grep -v "Warnings" | head -10
echo ""
...
echo ""
demo "📊 Résultats :"
./bin/cqlsh localhost 9042 -e "USE domirama2_poc; SELECT libelle, montant, cat_auto FROM operations_by_account WHERE code_si = '$CODE_SI' AND contrat = '$CONTRAT' AND libelle : 'loyer' AND libelle : 'paris' AND montant < -1000 LIMIT 5;" 2>&1 | grep -v "Warnings" | head -10
echo ""
...
./bin/cqlsh localhost 9042 -e "USE domirama2_poc; SELECT libelle, montant FROM operations_by_account WHERE code_si = '$CODE_SI' AND contrat = '$CONTRAT' AND libelle : 'loyr' LIMIT 5;" 2>&1 | grep -v "Warnings" | head -10
echo ""
...
echo ""
demo "📊 Résultats (attendu : 0 résultat) :"
./bin/cqlsh localhost 9042 -e "USE domirama2_poc; SELECT libelle, montant FROM operations_by_account WHERE code_si = '$CODE_SI' AND contrat = '$CONTRAT' AND libelle : 'parsi' LIMIT 5;" 2>&1 | grep -v "Warnings" | head -10
echo ""
...
echo ""
demo "📊 Résultats :"
./bin/cqlsh localhost 9042 -e "USE domirama2_poc; SELECT libelle, montant FROM operations_by_account WHERE code_si = '$CODE_SI' AND contrat = '$CONTRAT' AND libelle : 'loy' LIMIT 5;" 2>&1 | grep -v "Warnings" | head -10
echo ""
...
echo "  📊 STATISTIQUES"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
TOTAL=$(./bin/cqlsh localhost 9042 -e "USE domirama2_poc; SELECT COUNT(*) FROM operations_by_account;" 2>&1 | grep -v "Warnings" | grep -E "^[[:space:]]*[0-9]+" | head -1 | tr -d ' ')
