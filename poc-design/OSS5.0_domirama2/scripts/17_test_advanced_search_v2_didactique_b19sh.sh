...
FIRST_ACCOUNT=$(./bin/cqlsh "$HCD_HOST" "$HCD_PORT" -e "USE domirama2_poc; SELECT code_si, contrat FROM operations_by_account WHERE libelle : 'loyer' LIMIT 1;" 2>&1 | grep -v "Warnings" | grep -E "^[[:space:]]*[0-9]" | head -1)
...
echo "   ✅ Contexte et objectifs du POC (équivalences HBase → HCD)"
echo "   ✅ Explications détaillées des index utilisés"
echo "   ✅ Stratégies de recherche et recommandations"
...
echo ""
section "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
section "  📚 PARTIE 0: CONTEXTE - Pourquoi ces Tests de Recherche ?"
section "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo ""
...
echo "      - Exemple : GET /_search avec query JSON"
echo ""
echo "   HCD :"
...
echo "      - Exemple : SELECT ... WHERE libelle : 'terme'"
echo ""
...
echo ""
section "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
section "  📋 PARTIE 0.5: INDEX UTILISÉS DANS CES TESTS"
section "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo ""
