...
#   - Fichier CSV présent: data/operations_sample.csv
#
# UTILISATION :
#   ./11_load_domirama2_data_fixed_v2_didactique.sh [chemin_csv]
#
# PARAMÈTRES :
#   $1 : Chemin vers le fichier CSV (optionnel)
#        Par défaut: data/operations_sample.csv
#
# SORTIE :
...
REPORT_FILE="${SCRIPT_DIR}/doc/demonstrations/11_INGESTION_DEMONSTRATION.md"
...
echo ""
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo "  🎯 DÉMONSTRATION DIDACTIQUE : Chargement des Données Domirama2"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo ""
...
echo "   DataFrame Spark créé avec toutes les colonnes du fichier CSV"
echo "   Nombre de lignes lues affiché"
echo ""

info "📝 Code Spark - Lecture :"
echo ""
code "val inputPath = \"$CSV_FILE\""
code "val spark = SparkSession.builder()"
code "  .appName(\"Domirama2LoaderBatch\")"
...
echo "$SPARK_OUTPUT" | grep -E "(✅|📊|📥|🔄|💾|ERROR|Exception|opérations|Total|lignes)" || true
...
CAT_USER_SAMPLE=$(./bin/cqlsh localhost 9042 -e "USE domirama2_poc; SELECT cat_user FROM operations_by_account LIMIT 10;" 2>&1 | grep -v "Warnings" | grep -v "cat_user" | grep -vE "^---" | grep -v "^$" | head -1 | tr -d ' ')
...
echo "   ┌─────────────────────────────────────────────────────────┐"
./bin/cqlsh localhost 9042 -e "USE domirama2_poc; SELECT code_si, contrat, libelle, montant, cat_auto, cat_confidence, cat_user FROM operations_by_account LIMIT 5;" 2>&1 | grep -v "Warnings" | head -10 | sed 's/^/   │ /'
echo "   └─────────────────────────────────────────────────────────┘"
echo ""
