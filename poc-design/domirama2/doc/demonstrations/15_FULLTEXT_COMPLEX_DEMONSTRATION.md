...
**Date** : 2025-11-26 13:54:37
**Script** : 15_test_fulltext_complex_v2_didactique.sh
...
|------|-------------|-----------|-----------|--------|
| 1 | 'loyer paris' (multi-termes) | lowercase, stemming | 1 | ✅ |
| 2 | 'impaye' (asciifolding) | asciifolding | 13 | ✅ |
| 11 | 'loyers' (stemming) | frenchLightStem | 6 | ✅ |
| 18 | 'loyer paris' + montant < -500 | Tous + filtre | 1 | ✅ |
