...
def benchmark_vector_search(session, tokenizer, model, queries: list, code_si: str, contrat: str, iterations: int = 100):
...
def main():
    ...
    print("-" * 70)
    search_stats = benchmark_vector_search(session, tokenizer, model, test_queries, code_si, contrat, iterations=50)
